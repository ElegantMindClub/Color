# Eccentricity Dependence for BLUE, Binary Decision, 1/2/3 Colors
...
if recordData:
    ...
    fileName = os.path.join(OUTPATH,\
        (expInfo['Name'] + '_' + expInfo['Attention (Covert or Overt)'] + '_' + 'blue' + '_' + date + '_' + expName + '.csv'))
