# Eccentricity Dependence for GREEN, Binary Decision, 1/2/3 Colors
...
if recordData:
    ...
    fileName = os.path.join(OUTPATH,\
        (expInfo['Name'] + '_' + expInfo['Attention (Covert or Overt)'] + '_' + 'green' + '_' + date + '_' + expName + '.csv'))
...
def instructions():
    ...
    genDisplay({'text': 'Press F if you see a GREEN circle.',\
