...
grouplist[0].append('blue')
grouplist[0].append('yellow')
grouplist[1].append('yellow')
grouplist[1].append('blue')
grouplist[2].append('yellow')
grouplist[2].append('yellow')
grouplist[3].append('blue')
grouplist[3].append('blue')
trials = 30
...
if recordData:
    ...
    expName = 'NEW No Cue BY Two Decision'
...
def instructions():
    genDisplay({'text': 'Press "B" when you see the color blue',\
        'xPos': 0, 'yPos': centerY+3, 'heightCm': 1, 'color': 'white'}).draw()
    genDisplay({'text': 'and "V" when you see the color yellow',\
