...
expName = 'SingleColor_yellow'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\jagan\\Downloads\\ColorCenterExperiment1_lastrun.py',
...
ExperimentInstructions = visual.TextStim(win=win, name='ExperimentInstructions',
    text='Press b when you see circle appear\nPress any key to continue',
    font='Arial',
...
polygon_2 = visual.Polygon(
    ...
    edges=999, size=(2.74,2.74), #change size to 3.5cm diameter according to ruler
    ori=0, pos=(0, 0),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if key_resp_3.status == STARTED:
            theseKeys = key_resp_3.getKeys(keyList=['b'], waitRelease=False)
