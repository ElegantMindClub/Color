...
expName = 'TripleColor_green_red_yellow'  # from the Builder filename that created this script
...
ExperimentInstructions = visual.TextStim(win=win, name='ExperimentInstructions',
    text="Press 'v' if you see green\nPress 'b' if you see red\nPress 'n' if you see yellow\nPress any key to continue",
    font='Arial',
