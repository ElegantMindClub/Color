...
expName = 'TripleColor_blue_green_red'  # from the Builder filename that created this script
...
ExperimentInstructions = visual.TextStim(win=win, name='ExperimentInstructions',
    text="Press 'v' if you see blue\nPress 'b' if you see green\nPress 'n' if you see red\nPress any key to continue",
    font='Arial',
