...
#Change Line 108 size to a 3.5cm diameter circle according to your ruler
"""
...
expName = 'TripleColor_yellow_blue_green'  # from the Builder filename that created this script
...
ExperimentInstructions = visual.TextStim(win=win, name='ExperimentInstructions',
    text="Press 'v' if you see yellow\nPress 'b' if you see blue\nPress 'n' if you see green\nPress any key to continue",
    font='Arial',
...
trials = data.TrialHandler(nReps=90, method='random', 
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if key_resp_3.status == STARTED:
            theseKeys = key_resp_3.getKeys(keyList=['v', 'b', 'n'], waitRelease=False)
...
# completed 90 repeats of 'trials'
