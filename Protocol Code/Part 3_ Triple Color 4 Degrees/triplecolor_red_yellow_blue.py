...
expName = 'TripleColor_red_yellow_blue'  # from the Builder filename that created this script
...
ExperimentInstructions = visual.TextStim(win=win, name='ExperimentInstructions',
    text="Press 'v' if you see red\nPress 'b' if you see yellow\nPress 'n' if you see blue\nPress any key to continue",
    font='Arial',
