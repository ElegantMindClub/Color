...
expName = 'DualColor_green_blue'  # from the Builder filename that created this script
...
polygon_2 = visual.Polygon(
    ...
    edges=999, size=(4,4), #change to 3.5cm diameter according to ruler
    ori=0, pos=(0, 0),
